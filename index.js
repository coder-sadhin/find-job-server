...
const stripe = require("stripe")(
  "sk_test_51M6TOhLZ8s0yewmCKIERlWDqgmuV0dUPMcqr6t68lquLbV9ES0l7wH2zsYyXgZUjwvvhxFeUujmMHDWRGVOZnxSM00E1Hd7kmq"
);
    ...
    app.get("/jobs", async (req, res) => {
      ...
      if (jobstype === "all") {
        ...
        const filterData = result.filter((job) =>
          job.job_details.job.job_title.toLowerCase().includes(jobstype)
        );
